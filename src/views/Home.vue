    ...
    <el-row class="tac">
      <el-col>
        ...
        >
          ...
          <el-menu-item index="1-3" @click="navigateTo('EchartsPage')">
            <i class="el-icon-picture"></i>
            <span slot="title">图表页面</span>
          </el-menu-item>
        </el-menu>
      </el-col>
    </el-row>
    ...
    <el-container>
      <el-header class="one-el-header">
        <div class="header-position">
          ...
          <div class="Breadcrumb">
            ...
            <el-breadcrumb separator="/">
              <el-breadcrumb-item
                v-for="breadCrumbItem in breakCrumbList"
        ...
        <div class="headerright">
          <ul>
            ...
            <li>
              <img class="header-icon-img" src="../assets/全屏.png" alt="" />
            </li>
            <li>
              <img
                class="header-icon-img"
      ...
      <div class="loginbar">
        ...
        <div class="el-tag-one">
          <el-tag
            class="el-tag-item"
            v-for="(tag, index) in breakCrumbList"
            :key="tag.name"
            :type="tag.meta.type"
        ...
        <div class="logininfo">
          <!-- 登录姓名显示 -->
          <h1 v-if="getUser">欢迎, {{ getUser.username }}!</h1>
          <p v-else>请登录以查看您的信息。</p>
        </div>
      </div>
      <!-- 点击左侧的导航后 这个区域要切换页面 -->
      <el-main>
...
export default {
  ...
  computed: {
    ...
    // 使用 mapGetters 将 getUser 映射到组件的计算属性中
    ...mapGetters(["getUser"]),
  },
  methods: {
    ...mapActions(["logout"]),
